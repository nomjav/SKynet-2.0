#pragma checksum "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e885e6aa1fae09d0fa163140f11f7500c5d0fa1f"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e885e6aa1fae09d0fa163140f11f7500c5d0fa1f", @"/Views/Shared/JSONScripts/CallSlip.cshtml")]
...
#line 193 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
...
#line 686 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
...
#line 778 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
             Write(Url.Content("~/Customer/GetCustomerByStoreNumberOrCustomerId"));

#line default
#line hidden
            EndContext();
            BeginContext(29555, 17237, true);
            WriteLiteral(@""",
            data: JSON.stringify(request),
            success: function (msg) {
                var data;
   ...
   ");
    ...
    function FilleCustomerDetails(customer) {
        ...
        //$('#NotificationName').v");
            WriteLiteral(@"al(customer.customerNotificationName);
        ...
        if ((customer.CustomerType == 2) || (customer.CustomerType == 4)) {
            $('.rbBilling').attr('disabled', false);
   ");
            WriteLiteral(@"         $('input[type=""radio""][value=""1""]').attr('checked', 'checked');
        }
    }
        ...
        if ($(ctlr).is(':checked')) {
            if ($('#CallSlipId').val().length > 0) {
                ...
                $.ajax({
                    ...
                    url: '");
            EndContext();
            BeginContext(46793, 37, false);
#line 1195 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
                     Write(Url.Content("~/CallSlip/SaveService"));

#line default
#line hidden
            EndContext();
            BeginContext(46830, 1457, true);
            WriteLiteral(@"',
                    contentType: 'application/json, charset=utf-8',
                    data: JSON.stringify(request),
                    success: function (msg) {
    ...
    function DeleteServiceMapped(id) {
        ...
        $.ajax({
            ...
            url: '");
            EndContext();
            BeginContext(48288, 39, false);
#line 1226 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
             Write(Url.Content("~/CallSlip/DeleteService"));

#line default
#line hidden
            EndContext();
            BeginContext(48327, 2066, true);
            WriteLiteral(@"',
            contentType: 'application/json, charset=utf-8',
            data: JSON.stringify(request),
            success: function (msg) {
...
");
            WriteLiteral("            url: \"");
            EndContext();
            BeginContext(50394, 36, false);
#line 1275 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
             Write(Url.Content("~/CallSlip/GetJobById"));

#line default
#line hidden
            EndContext();
            BeginContext(50430, 3849, true);
            WriteLiteral(@""",
            data: JSON.stringify(request),
            success: function (msg) {
                var data;
    ...
    function SaveCallType(calltypeid) {
        ...
        $.ajax({
            ...
            url: """);
            EndContext();
            BeginContext(54280, 38, false);
#line 1375 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
             Write(Url.Content("~/CallSlip/SaveCallType"));

#line default
#line hidden
            EndContext();
            BeginContext(54318, 1792, true);
            WriteLiteral(@""",
            data: JSON.stringify(request),
            success: function (msg) {
                var data;
    ...
    function DeleteDocumentByCallSlipIdDocumentId(docId) {
        ...
        $.ajax({
            ...
            url: """);
            EndContext();
            BeginContext(56111, 40, false);
#line 1420 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
             Write(Url.Content("~/CallSlip/DeleteDocument"));

#line default
#line hidden
            EndContext();
            BeginContext(56151, 1075, true);
            WriteLiteral(@""",
            data: JSON.stringify(request),
            success: function (msg) {
                var data;
    ...
    $('#CustomerName').autocomplete({
        ...
        source: function (request, response) {
            ...
            WriteLiteral("();\r\n\r\n            $.ajax({\r\n                url: \'");
            EndContext();
            BeginContext(57227, 50, false);
#line 1460 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
                 Write(Url.Content("~/Customer/GetAutocompleteCustomers"));

#line default
#line hidden
            EndContext();
            BeginContext(57277, 1617, true);
            WriteLiteral(@"',
        ...
        select: function (event, ui) {
            ...
            if(");
            EndContext();
            BeginContext(58895, 33, false);
#line 1505 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
          Write(ViewBag.OverrideCreditWorthyCheck);

#line default
#line hidden
            EndContext();
            BeginContext(58928, 385, true);
            WriteLiteral(@" != 1)
            {
    ...
    function GetCustomerProjects(Id)
    {
        ...
        $.ajax({
            ...
            url: """);
            EndContext();
            BeginContext(59314, 37, false);
#line 1522 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
             Write(Url.Content("~/Customer/GetProjects"));

#line default
#line hidden
            EndContext();
            BeginContext(59351, 1624, true);
            WriteLiteral(@""",
            data: JSON.stringify(request),
            dataType: ""json"",
            success: function (msg) {
    ...
    function checkCreditWorthy(Id)
    {
        ...
        $.ajax({
            ...
            url: """);
            EndContext();
            BeginContext(60976, 43, false);
#line 1566 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
             Write(Url.Content("~/Customer/CheckCreditWorthy"));

#line default
#line hidden
            EndContext();
            BeginContext(61019, 518, true);
            WriteLiteral(@""",
            data: JSON.stringify(request),
            success: function (data) {
                if(data.success)
    ...
    $('#Stores').autocomplete({
        source: function (request, response) {
            $.ajax({
                url: '");
            EndContext();
            BeginContext(61538, 45, false);
#line 1584 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
                 Write(Url.Content("~/Customer/GetStoresonCallSlip"));

#line default
#line hidden
            EndContext();
            BeginContext(61583, 1355, true);
            WriteLiteral(@"',
    ...
    function GetCustomerInformationByPhone()");
        ...
        if ($('#Phone').val().length < 1) {
            ...
            $.ajax({
                url: '");
            EndContext();
            BeginContext(62939, 55, false);
#line 1624 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
                 Write(Url.Content("~/Customer/GetCustomerInformationByPhone"));

#line default
#line hidden
            EndContext();
            BeginContext(62994, 1117, true);
            WriteLiteral(@"',
    ...
    function GetEquipments() {
        $.ajax({
            ...
            EndContext();
            BeginContext(64112, 40, false);
#line 1655 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
             Write(Url.Content("~/Equipment/GetEquipments"));

#line default
#line hidden
            EndContext();
            BeginContext(64152, 2714, true);
            WriteLiteral(@""",
            success: function (msg) {
                var data;
                if (msg.hasOwnProperty(""d"")) {
    ...
    $('#Phone').autocomplete({
        ...
        source: function (request, response) {
            ...
            $.ajax({
                url: '");
            EndContext();
            BeginContext(66867, 49, false);
#line 1729 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
                 Write(Url.Content("~/Customer/GetCustomerPhoneNumbers"));

#line default
#line hidden
            EndContext();
            BeginContext(66916, 2089, true);
            WriteLiteral(@"',
    ...
    function GetResidentialEquipments() {
        $.ajax({
            ...
            EndContext();
            BeginContext(69006, 51, false);
#line 1798 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
             Write(Url.Content("~/Equipment/GetResidentialEquipments"));

#line default
#line hidden
            EndContext();
            BeginContext(69057, 713, true);
            WriteLiteral(@""",
            global:false,
            success: function (msg) {
                var data;
    ...
    function GetCommercialEquipments() {
        $.ajax({
            ...
            url: """);
            EndContext();
            BeginContext(69771, 50, false);
#line 1822 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
             Write(Url.Content("~/Equipment/GetCommercialEquipments"));

#line default
#line hidden
            EndContext();
            BeginContext(69821, 949, true);
            WriteLiteral(@""",
            global:false,
            success: function (msg) {
                var data;
    ...
    function AutoCheckBoxChangeEvent() {
        ...
        if (isAutoChecked) {
            $.ajax({
                ...
                url: """);
            EndContext();
            BeginContext(70771, 44, false);
#line 1853 "C:\Work\Skynet 2.0\Skynet.Web\Views\Shared\JSONScripts\CallSlip.cshtml"
                 Write(Url.Content("~/Equipment/GetAutoEquipments"));

#line default
#line hidden
            EndContext();
            BeginContext(70815, 1186, true);
            WriteLiteral(@""",
                global:false,
                success: function (msg) {
                    var data;
